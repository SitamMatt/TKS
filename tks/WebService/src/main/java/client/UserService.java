 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://superbiz.org/wsdl", wsdlLocation = "http://localhost:8080/tks-soap/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://superbiz.org/wsdl", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/tks-soap/UserService?wsdl");
     ...
     * 
     * @return
     *     returns IUserWebService
     */
    @WebEndpoint(name = "UserPort")
    public IUserWebService getUserPort() {
        return super.getPort(new QName("http://superbiz.org/wsdl", "UserPort"), IUserWebService.class);
    }
     ...
     */
    @WebEndpoint(name = "UserPort")
    public IUserWebService getUserPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://superbiz.org/wsdl", "UserPort"), IUserWebService.class, features);
    }

 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8080/tks-soap/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://webservice/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/tks-soap/HelloService?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://webservice/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "HelloPort"), Hello.class, features);
    }

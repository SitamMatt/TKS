...
public class ObjectFactory {
    ...
    private final static QName _SayHiResponse_QNAME = new QName("http://webservice/", "sayHiResponse");
    private final static QName _SayHi_QNAME = new QName("http://webservice/", "sayHi");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "sayHiResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "sayHi")
